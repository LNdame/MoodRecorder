...
public class EmojiContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://cct.ansteph.moodrecorder.contentprovider.emojicontentprovider/moodrecorder");
    private SQLiteDatabase db;

    public DbHelper databhelper ;


    public EmojiContentProvider() {
    }

    @Override
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        // Implement this to handle requests to delete one or more rows.
        int retVal = db.delete(Tables.EMOJI_TABLE, selection,selectionArgs);
    ...
    public Uri insert(Uri uri, ContentValues inValues) {
        ...
        long rowId = db.insert(Tables.EMOJI_TABLE, EmojiColumns.MOODNAME, values);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        {
            orderBy = EmojiColumns.MOODNAME;
        }else {
            orderBy =sortOrder;
        }

        Cursor c = db.query(Tables.EMOJI_TABLE, projection,selection,selectionArgs,null,null,orderBy);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        int retVal = db.update(Tables.EMOJI_TABLE, values, selection,selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);
