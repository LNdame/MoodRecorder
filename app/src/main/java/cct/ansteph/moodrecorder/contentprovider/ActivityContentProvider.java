...
public class ActivityContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://cct.ansteph.moodrecorder.contentprovider.activitycontentprovider/moodrecorder");
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int retVal = db.delete(Tables.ACTIVTY_TABLE, selection,selectionArgs);
    ...
    public Uri insert(Uri uri, ContentValues inValues) {
        ...
        long rowId = db.insert(Tables.ACTIVTY_TABLE, ActivityColumns.NAME, values);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        {
            orderBy = ActivityColumns.NAME;
        }else {
            orderBy =sortOrder;
        }

        Cursor c = db.query(Tables.ACTIVTY_TABLE, projection,selection,selectionArgs,null,null,orderBy);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        int retVal = db.update(Tables.ACTIVTY_TABLE, values, selection,selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);
