...
public class PdfCustFooter extends PdfPageEventHelper {
    ...
    public PdfCustFooter() {
        headerMsg = "Catch-ur-Mood";

        this.footerMsg ="This report was generated by Catch-ur-Mood Mood Diary for more info http://cct.mandela.ac.za";
    }
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        Phrase header = new Phrase("Catch-ur-Mood", ffont);
        Phrase footer = new Phrase("This report was generated by Catch-ur-Mood Mood Diary for more info http://cct.mandela.ac.za", ffont);
