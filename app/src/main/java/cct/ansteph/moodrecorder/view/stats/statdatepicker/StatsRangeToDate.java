...
public class StatsRangeToDate extends DialogFragment implements DatePickerDialog.OnDateSetListener{
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        TextView txtToDate = (TextView) getActivity().findViewById(R.id.txtToDate);
        ...
        txtToDate.setText(String.valueOf(year) +"-"+ monthcon +"-"+  daycon);
    }
}
